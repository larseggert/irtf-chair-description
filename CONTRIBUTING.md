...
documents](https://datatracker.ietf.org/wg/irtf/documents/) and [mailing
list discussion](https://mailarchive.ietf.org/arch/browse/irtf/). If you're
...
([info](https://www.ietf.org/mailman/listinfo/irtf)). This will ensure that
